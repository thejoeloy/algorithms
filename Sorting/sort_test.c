...
void TestMergeSort() {
    ...
    MergeSort(int_list, 0, size_int - 1, IntCmp, sizeof(int));
    ...
    MergeSort(float_list, 0, size_float - 1, FloatCmp, sizeof(float));
    ...
    MergeSort(char_list, 0, size_char - 1, CharCmp, sizeof(char));
    ...
    MergeSort((void*)str_list, 0, size_str - 1, StringCmp, sizeof(char*));
...
void TestInsertionSort() {
    ...
    InsertionSort(int_list, size_int, IntCmp, sizeof(int));
    ...
    InsertionSort(float_list, size_float, FloatCmp, sizeof(float));
    ...
    InsertionSort(char_list, size_char, CharCmp, sizeof(char));
    ...
    InsertionSort((void*)str_list, size_str, StringCmp, sizeof(char*));
